// Vendored verbatim from k2-fsa/sherpa-onnx v1.13.2 (Apache-2.0):
//   sherpa-onnx/kotlin-api/Tts.kt
// The Kotlin API is source-vendored; the matching native libs (libsherpa-onnx-jni.so)
// are supplied via src/main/jniLibs/ from the v1.13.2 android release tarball. Do not edit
// by hand — re-vendor from the pinned tag if upgrading. See voice/quark-phase2b/HANDOFF.md.
