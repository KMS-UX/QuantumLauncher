package com.quantumos.config.ui.components
...
/*
 * CONFIG's docked App Shell wrapper (SIGNAL + CONFIG Task Brief §4). Delegates the CRT container and
 * nameplate to :app-shell -- never reimplemented locally, same shape as every other docked module. No
