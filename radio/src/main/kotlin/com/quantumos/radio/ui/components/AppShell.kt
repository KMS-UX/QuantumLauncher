...
/*
 * RADIO's docked App Shell wrapper (Core Apps Fix-Pass, Decision 86). Delegates the CRT container
 ...
 *
 * Unlike Optics's wrapper, RADIO has no shutter button or other control that needs to live outside
 * the content lambda -- the tuning dial, band row, and presets are all inside RadioScreen's own
 * content, so this wrapper stays a thin nameplate + return-home affordance only.
 */
@Composable
fun AppShell(
    title: String,
